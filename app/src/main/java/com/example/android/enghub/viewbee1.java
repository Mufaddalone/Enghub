...
public class viewbee1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewbee1);
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("bee");
