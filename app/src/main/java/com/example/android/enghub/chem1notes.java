...
public class chem1notes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chem1notes);

        editPDFName= (EditText) findViewById(R.id.notification);
        btn_upload= (Button)findViewById(R.id.upload);

        storageReference= FirebaseStorage.getInstance().getReference();
        databaseReference= FirebaseDatabase.getInstance().getReference("chem1");
    ...
    public void btn_action(View view) {
        startActivity(new Intent(getApplicationContext(),viewchem1.class));
    }
}