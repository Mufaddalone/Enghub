...
public class view_phy1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_phy1);
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("phy1");
