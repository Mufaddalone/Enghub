...
public class viewmech1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewmech1);
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("mech");
