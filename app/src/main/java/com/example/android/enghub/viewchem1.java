...
public class viewchem1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewchem1);
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("chem1");
