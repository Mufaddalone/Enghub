...
public class bee1notes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bee1notes);

        editPDFName= (EditText) findViewById(R.id.notification);
        btn_upload= (Button)findViewById(R.id.upload);

        storageReference= FirebaseStorage.getInstance().getReference();
        databaseReference= FirebaseDatabase.getInstance().getReference("bee");
    ...
    public void btn_action(View view) {
        startActivity(new Intent(getApplicationContext(),viewbee1.class));
    }
}